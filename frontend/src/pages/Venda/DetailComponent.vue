      ...
      if (id !== 'nova') {
        VendasService.getById(id).then(result => {
          if (result instanceof Error) {
            ...
            const { venda } = result;
            formData.data = venda.data;
            formData.produto_id = venda.produto_id;
            formData.pessoa_id = venda.pessoa_id;
...
../../../shared/api/vendas/VendasService../../../shared/services/api/vendas/VendasService
